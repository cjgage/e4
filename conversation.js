    ...
    function setupInputBox() {
        ...
        function adjustInput() {
            if (input.value === '') {
                ...
                input.setAttribute('style', 'width:' + 'calc(100% - 100px)');
    ...
    function displayMessage(newPayload, typeValue) {
        ...
        if (isUser !== null && textExists) {
            if (newPayload.output && newPayload.output.text) {
                console.log("Output:", newPayload.output.text[0]);


              $.ajax({
  method: "POST",
  url: "https://gagexp4.mybluemix.net/e4house",
  data: newPayload
})
  .done(function( msg ) {
    console.log("Sent successfully");
       ...
       //         audio.src = "https://cdn.online-convert.com/example-file/audio/ogg/example.ogg";

//                $.ajax({
//                    "url": "/api/synthesize?text=" + newPayload.output.text[0] + "&accept=audio%2Fogg;codecs=opus&download=true",
//                    "headers": {
...
//                        console.log(newurl);
                  ...
                  audio.src="/api/synthesize?text="+newPayload.output.text[0];
                //      audio.src = newurl;
